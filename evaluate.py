...
import sys
if "/home/lidong1/.local/lib/python3.9/site-packages/" in sys.path:
    sys.path.remove("/home/lidong1/.local/lib/python3.9/site-packages/")
...
try:
    ...
    print("WARNING transformers.mpu not found")
...
from evaluate_sp import evaluate_sp, prepare_dataset_sp
...
def main():
    ...
    if args.type == "eval_main":
        ...
        evaluate_sp(args, tokenizer, model, dataset["test"], "test", 0, device, ds_config)
    else:
        raise NotImplementedError
