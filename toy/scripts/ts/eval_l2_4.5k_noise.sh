...
OPTS+=" --model-path ${BASE_PATH}/checkpoints/tiny_stories/tiny-128-l2-4.5k"
OPTS+=" --ckpt-name toy-trm-l2-4.5k-ln"
# data
OPTS+=" --train-num 8192"
OPTS+=" --dev-num 512"
OPTS+=" --test-num 512"
OPTS+=" --data-names toy-ts"
OPTS+=" --data-dir ${BASE_PATH}/processed_data/toy-ts/mistral/small_64_8192_512_2"
