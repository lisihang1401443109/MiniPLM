...
paths = [
    ...
    # (os.path.join(base_path, "opt_alpha_0.1/8"), "opt_alpha_5"),
    ...
    # (os.path.join(base_path, "opt_alpha_0.2/6"), "opt_alpha_5"),
    (os.path.join(base_path, "opt_alpha_0.2/7"), "opt_alpha_5"),
    # (os.path.join(base_path, "opt_alpha_0.2/8"), "opt_alpha_5"),
    (os.path.join(base_path, "opt_alpha_0.2/9"), "opt_alpha_5"),
    # (os.path.join(base_path, "opt_alpha_0.2/10"), "opt_alpha_5"),
    (os.path.join(base_path, "opt_alpha_0.2/11"), "opt_alpha_5"),
    # (os.path.join(base_path, "opt_alpha_0.2/10"), "opt_alpha_5"),
    (os.path.join(base_path, "opt_alpha_0.2/15"), "opt_alpha_5"),
    # (os.path.join(base_path, "opt_alpha_0.2/13"), "opt_alpha_5"),
...
cbar.set_label(r"$\operatorname{CR}$", fontsize=font_size, labelpad=-30, y=-0.04, rotation=0)
