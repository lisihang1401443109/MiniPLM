...
for i in steps:
    if i == -1:
        ...
        _, test_losses = torch.load(os.path.join(base_path, f"opt_alpha_0.001/{i}/all_loss.pt"), map_location="cpu")
...
l1, = ax1.plot(steps, test_areas,
               label=r"$J(\gamma)$", color="tab:green")
...
plt.savefig(os.path.join("/home/lidong1/yuxian/sps-toy/results/toy/icml/", "area_loss_linear.pdf"), bbox_inches="tight")