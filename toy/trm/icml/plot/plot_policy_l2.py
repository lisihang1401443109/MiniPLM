...
alpha_path = "/home/lidong1/yuxian/sps-toy/results/toy/trm/toy-trm-l2-5k-ln-ts-64/bs512-lr0.1-tn16384-dn512-e4000/-0.8_30-opt-0.4-0/10-20-7/epoch_5/opt_alpha.pt"
...
alpha = torch.clamp(alpha, min=0, max=torch.max(alpha)/2000)
...
ax.set_yticks([0, 1000, 2000], ["0", "1k", "2k"])
ax.set_xticks([0, 1000, 2000, 3000, 4000], ["0", "1k", "2k", "3k", "4k"])
# ax.set_ylim(ymin=0)
# ax.invert_xaxis()
print(alpha.shape)
...
plt.savefig(os.path.join("/home/lidong1/yuxian/sps-toy/results/toy/icml",
            f"{split}_alpha.png"), bbox_inches="tight", dpi=300)
plt.close()