...
base_path = "/home/lidong1/yuxian/sps-toy/results/toy/trm/toy-trm-l2-4.5k-ln-ts-64/bs512-lr0.1-tn8192-dn512-e2000/-0.8_30-eval_opt/10-20-7/"
...
paths = [
    ...
    os.path.join(base_path, "opt_alpha_0.6/16"),
