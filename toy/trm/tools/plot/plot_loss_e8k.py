...
base_path = "/home/lidong1/yuxian/sps-toy/results/toy/trm/toy-trm-6k-ln-ts-64/bs512-lr0.1-tn32768-dn512-e8000/-0.8_30-eval_opt/10-20-7"
...
bsl_test_losses = gaussian_filter1d(bsl_test_losses, sigma=10)
opt_test_losses = gaussian_filter1d(opt_test_losses, sigma=10)
...
plt.annotate(text='', xy=(max_steps+50,bsl_test_losses[-1]-0.01), xytext=(1700,bsl_test_losses[-1]-0.01), arrowprops=dict(arrowstyle='<->'))
plt.text(2600, bsl_test_losses[-1]-0.17, r"$\operatorname{AR}(T) = 2.35$", fontsize=12)
